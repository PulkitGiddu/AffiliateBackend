-- Seed data for local H2 (profile=local). Not used for PostgreSQL.
-- Fixed UUIDs so we can reference them in FK columns.
...
VALUES
('d1eebc99-9c0b-4ef8-bb6d-6bb9bd380a41', 'Wireless Bluetooth Earbuds', 'Noise cancelling, 24hr battery', 'PROD-001', 2999.00, 1999.00, 4.5, 120, 'https://example.com/earbuds', 'https://picsum.photos/seed/1/400/400', 'b1eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', 'c1eebc99-9c0b-4ef8-bb6d-6bb9bd380a31', true, CURRENT_TIMESTAMP + 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('d2eebc99-9c0b-4ef8-bb6d-6bb9bd380a42', 'Smart Watch Pro', 'Heart rate, GPS, 50m water resistant', 'PROD-002', 8999.00, 5999.00, 4.2, 89, 'https://example.com/watch', 'https://picsum.photos/seed/2/400/400', 'b1eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', 'c1eebc99-9c0b-4ef8-bb6d-6bb9bd380a31', true, CURRENT_TIMESTAMP + 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
(RANDOM_UUID(), 'SAVE10', '10% off on first order', 'PERCENT', 10.00, CURRENT_TIMESTAMP + 30, 'b1eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(RANDOM_UUID(), 'FLAT500', 'Rs 500 off on orders above Rs 2999', 'FLAT', 500.00, CURRENT_TIMESTAMP + 14, 'b2eebc99-9c0b-4ef8-bb6d-6bb9bd380a23', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 6. Notifications (for demo user)
INSERT INTO notifications (id, user_id, message, is_read, created_at)
VALUES
(RANDOM_UUID(), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Welcome to SnatchMart! Check out today''s top deals.', false, CURRENT_TIMESTAMP),
(RANDOM_UUID(), 'a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11', 'Price drop alert: Wireless Earbuds now at Rs 1999.', false, CURRENT_TIMESTAMP);

-- 7. Price history for first product (so product detail shows history)
INSERT INTO product_price_history (id, product_id, price, recorded_at)
VALUES
(RANDOM_UUID(), 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a41', 2999.00, CURRENT_TIMESTAMP - 2),
(RANDOM_UUID(), 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a41', 2499.00, CURRENT_TIMESTAMP - 1),
(RANDOM_UUID(), 'd1eebc99-9c0b-4ef8-bb6d-6bb9bd380a41', 1999.00, CURRENT_TIMESTAMP);
